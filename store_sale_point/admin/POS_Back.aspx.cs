...
{
    public partial class POS_Back : System.Web.UI.Page
    {
        ...
        public void findorderid()
        {
            ...
            String orderid;
            orderid = "SB-" + DateTime.Now.Hour.ToString() + DateTime.Now.Minute.ToString() + DateTime.Now.Second.ToString() + DateTime.Now.Day.ToString() + DateTime.Now.Month.ToString() + DateTime.Now.Year.ToString() + new string(mypass);
