<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="setting_permission_Activation_users.aspx.cs" Inherits="store_sale_point.admin.setting_permission_Activation_users" %>
                    ...
                    <asp:GridView ID="grdUsers" AutoGenerateColumns="false" AllowPaging="true" PageSize="15"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="نشط ام لا">
                                <ItemTemplate>
                                    <asp:Label Visible="false" ID="lbluser_active_or_no" runat="server" Text='<%# Eval("user_active_or_no") %>' />
