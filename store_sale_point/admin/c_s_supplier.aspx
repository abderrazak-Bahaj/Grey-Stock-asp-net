<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="c_s_supplier.aspx.cs" Inherits="store_sale_point.admin.c_s_supplier" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="widget-head">
        <asp:Label ID="lblheadertxt" runat="server" Text=" المورديـن  - Suppliers " Font-Size="Large" Font-Bold="true" ForeColor="SkyBlue"></asp:Label>
    </div>
    <div style="width: 100%; margin-top: 20px;">
        ...
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <div>
                    <asp:GridView ID="grdSupplier" AutoGenerateColumns="false" AllowPaging="true" PageSize="15" DataKeyNames="user_id" runat="server"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="H1">تعديل على بيانات المـورد</h5>
                            </div>
                            ...
                            <div class="modal-body body-mod text-center">
                                ...
                                <table>
                                    <tr>
                                        <td class="pull-left" style="font-family: Tahoma">اسم المورد</td>
                                        <td colspan="2">
                ...
                <div class="modal fade bd-example-modal-lg" id="ShowAdd" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="H2">إضافة مورد جـديد</h5>
                            </div>
