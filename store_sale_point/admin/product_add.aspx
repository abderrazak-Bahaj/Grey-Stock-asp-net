<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="product_add.aspx.cs" Inherits="store_sale_point.admin.product_add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="widget-head">
        <asp:Label ID="lblheadertxt" runat="server" Text=" اضافة المنتجات - Add Products " Font-Size="Large" Font-Bold="true" ForeColor="SkyBlue"></asp:Label>
    </div>
                ...
                <td style="margin-top: 20px">
                    <div id="Div1" class="fileupload fileupload-new" data-provides="fileupload" runat="server">
                        ...
                        <div class="input-append">
                            ...
                            <asp:LinkButton OnClientClick="ClearImage();" runat="server" class="btn fileupload-exists" data-dismiss="fileupload" ID="removePic" OnClick="removePic_Click">Remove</asp:LinkButton>
                        </div>
                    </div>
                </td>
            </tr>
    ...
    <div style="margin-right: 50px; margin: 10px; border: 1px solid #e6e5e5; padding: 10px; width: 50%; float: right;">
        <table>
                                        ...
                                        <ContentTemplate>
                                            <asp:Panel ID="pnlPopup" runat="server" CssClass="ModalPanel">
                                                ...
                                                <asp:GridView ID="grdcategory" runat="server" AutoGenerateColumns="false"
                                                    ...
                                                    OnPageIndexChanging="grdcategory_PageIndexChanging" OnPageIndexChanged="grdcategory_PageIndexChanged"
            ...
            <tr>
                <td></td>
                <td>
                    <asp:LinkButton ID="btnNew" runat="server" OnClick="btnNew_Click"><img src="../img/add.png" /></asp:LinkButton>&nbsp &nbsp
