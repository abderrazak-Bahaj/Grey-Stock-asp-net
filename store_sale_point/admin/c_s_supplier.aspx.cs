...
{
    public partial class c_s_supplier : System.Web.UI.Page
    {
        ...
        {
            SqlDataAdapter sda = new SqlDataAdapter(@"select user_id,user_fullname,user_phone,user_email,user_address from all_users where user_kind_id=1 and user_fullname+user_phone+user_address+user_email LIKE '%" + txtSearch.Text + "%'", sc);
        ...
        {
            string id = grdSupplier.DataKeys[e.RowIndex].Value.ToString();
            deleteSupplier(id);
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            ...
            loadDataSupplier();
            Response.Redirect("c_s_supplier.aspx");
        }
        ...
        protected void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            SqlDataAdapter sda = new SqlDataAdapter(@"insert into all_users (user_fullname,user_phone,user_email,user_address,user_datecreation,user_kind_id) 
                                 values ('" + txtadduser_fullname.Text + "','" + txtadduser_phone.Text + "','" + txtadduser_email.Text + "','" + txtadduser_address.Text + "','" + times.ToString(formats) + "',1)", sc);
            DataTable dt = new DataTable();
            sda.Fill(dt);
