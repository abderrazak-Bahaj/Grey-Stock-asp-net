<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="PO_Purchase_Back.aspx.cs" Inherits="store_sale_point.admin.PO_Purchase_Back" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="widget-head" style="margin-bottom: 20px;">
        <asp:Label ID="lblheadertxt" runat="server" Text=" مرتجع مشتريات  - Purchases Return " Font-Size="Large" Font-Bold="true" ForeColor="SkyBlue"></asp:Label>
    </div>
                ...
                <div style="width: 50%; float: right; text-align: center; margin-top: 20px">
                    <div class="input-append">
                        <table>
                            <tr>
                                <td>
                                    <asp:TextBox ID="txtSerachId" AutoCompleteType="Disabled" runat="server" Width="230px" placeholder="من فضلك ادخل الفاتورة"></asp:TextBox></td>
                                <td>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title" id="exampleModalLabel"> طباعة فاتورة مرتجع المشتريات </h5>
