<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Site1.Master" AutoEventWireup="true" CodeBehind="setting_box_account.aspx.cs" Inherits="store_sale_point.admin.setting_box_account" %>
    ...
    <div style="margin-right: 50px; margin: 10px; border: 1px solid #e6e5e5; padding: 10px; width: 50%">
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtbox_account_id" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="مطلوب" ControlToValidate="txtbox_account_id" Display="Dynamic" ForeColor="#FF9900" SetFocusOnError="True" ValidationGroup="1"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td>النـــوع
                </td>
                <td>
                    <asp:TextBox ID="txtbox_account_name" runat="server"></asp:TextBox>
                </td>
                <td>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="مطلوب" ControlToValidate="txtbox_account_name" Display="Dynamic" ForeColor="#FF9900" SetFocusOnError="True" ValidationGroup="1"></asp:RequiredFieldValidator></td>
            </tr>
            <tr>
                <td>ملاحظات</td>
                <td>
                    <asp:TextBox ID="txtbox_account_notes" runat="server" TextMode="MultiLine"></asp:TextBox></td>
                <td></td>
            </tr>
            <tr>
                <td></td>
    ...
    <div style="margin-right: 50px; margin: 10px; border: 1px solid #e6e5e5; padding: 10px; width: 80%">
        <asp:UpdatePanel ID="UpdatePanel1" runat="server">
            <ContentTemplate>
                ...
                <asp:GridView ID="grd" DataKeyNames="box_account_id" runat="server" AllowPaging="true" PageSize="5"
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="الــرقم" ItemStyle-Width="60px">
                            <ItemTemplate>
                                <asp:Label ID="lblbox_account_id" runat="server" Text='<%# Eval("box_account_id") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:Label ID="lbbox_account_id" runat="server" Text='<%# Eval("box_account_id") %>'></asp:Label>
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="النــوع">
                            <ItemTemplate>
                                <asp:Label ID="lblbox_account_name" runat="server" Text='<%# Eval("box_account_name") %>' />
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txteditbox_account_name" runat="server" Text='<%# Eval("box_account_name") %>' />
                            </EditItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="ملاحــظات">
                            <ItemTemplate>
                                <asp:Label ID="lblbox_account_notes" runat="server" Text='<%# Eval("box_account_notes") %>'></asp:Label>
                            </ItemTemplate>
                            <EditItemTemplate>
                                <asp:TextBox ID="txteditbox_account_notes" runat="server" Text='<%# Eval("box_account_notes") %>'></asp:TextBox>
                            </EditItemTemplate>
                        </asp:TemplateField>
